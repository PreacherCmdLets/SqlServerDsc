<#
    .SYNOPSIS
        Automated unit test for MSFT_SqlAgentNotification DSC resource.
...
$script:dscResourceName = 'MSFT_SqlAgentNotification'
...
try
{
    ...
    InModuleScope $script:dscResourceName {
        ...
        $mockSqlAgentAlert = '825'
        $mockSqlAgentNotificationEmail = $true
        $mockSqlAgentNotificationPager = $false
                        ...
                        return (New-Object -TypeName Object |
                            ...
                            Add-Member -MemberType ScriptProperty -Name Operators -Value {
                                return ( New-Object -TypeName Microsoft.SqlServer.Management.Smo.Agent.Operator |
                                    ...
                                    Add-Member -MemberType ScriptMethod -Name EnumNotifications {
                                        return ( New-Object -TypeName Object |
                                            Add-Member -MemberType NoteProperty -Name AlertName -Value $mockSqlAgentAlert -PassThru |
                                            Add-Member -MemberType NoteProperty -Name HasEmail -Value $mockSqlAgentNotificationEmail -PassThru
                                        )
                                    } -PassThru -Force
...
#>
        ...
        Describe "MSFT_SqlAgentNotification\Get-TargetResource" -Tag 'Get' {
            BeforeEach {
